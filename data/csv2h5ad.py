...
# def main():
#     data_omic = 'rna'
#     datafolder = '/workspace/juncheng/data/ours'
#     csv_floder = f'{datafolder}/mat/{data_omic}'
    
#     data = []
#     for file in os.listdir(csv_floder):
#         print(file)
#         if file.endswith('.csv'):
#             input_file = f'{csv_floder}/{file}'
#             current = convert_dense_csv_to_sparse_h5ad(input_file, output_floder=f'{datafolder}/h5ad/{data_omic}')
#             print(f'{file} converted to h5ad')
#             data.append(current)
